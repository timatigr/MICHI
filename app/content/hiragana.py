...
KANA = [
    # --- あ行 ---
    {"char": "あ", "romaji": "a",   "kind": "basic", "row": "a",  "mnemonic": "Антенна на крыше дома — «А-а, ловит!»", "lookalikes": ["お", "め", "ぬ"]},
    {"char": "い", "romaji": "i",   "kind": "basic", "row": "a",  "mnemonic": "Две сосульки рядом — «И-и, холодно!»", "lookalikes": ["り", "こ"]},
    {"char": "う", "romaji": "u",   "kind": "basic", "row": "a",  "mnemonic": "Утка нырнула клювом вперёд — «У!»", "lookalikes": ["つ", "ら"]},
    {"char": "え", "romaji": "e",   "kind": "basic", "row": "a",  "mnemonic": "Экзотическая птица на ветке — «Э!»", "lookalikes": ["そ", "ん"]},
    {"char": "お", "romaji": "o",   "kind": "basic", "row": "a",  "mnemonic": "Облако с хвостиком — «О!»", "lookalikes": ["あ", "む"]},
    # --- か行 ---
    {"char": "か", "romaji": "ka",  "kind": "basic", "row": "ka", "mnemonic": "КАтана, рассекающая воздух", "lookalikes": ["や", "せ"]},
    {"char": "き", "romaji": "ki",  "kind": "basic", "row": "ka", "mnemonic": "КЛЮЧ (key) с двумя зубцами", "lookalikes": ["さ", "ち"]},
    {"char": "く", "romaji": "ku",  "kind": "basic", "row": "ka", "mnemonic": "КЛЮв птицы, раскрытый — «ку-ку»", "lookalikes": ["へ", "し"]},
    {"char": "け", "romaji": "ke",  "kind": "basic", "row": "ka", "mnemonic": "КЕгля у стены", "lookalikes": ["は", "ほ"]},
    {"char": "こ", "romaji": "ko",  "kind": "basic", "row": "ka", "mnemonic": "Две КОроткие полки", "lookalikes": ["に", "い"]},
    # --- さ行 ---
    {"char": "さ", "romaji": "sa",  "kind": "basic", "row": "sa", "mnemonic": "САмолётик с одним крылом", "lookalikes": ["き", "ち"]},
    {"char": "し", "romaji": "shi", "kind": "basic", "row": "sa", "mnemonic": "Леска с крючком — «ШИкарный улов»", "lookalikes": ["く", "つ"]},
    {"char": "す", "romaji": "su",  "kind": "basic", "row": "sa", "mnemonic": "Петля на верёвке — «СУ-узел»", "lookalikes": ["む", "お"]},
    {"char": "せ", "romaji": "se",  "kind": "basic", "row": "sa", "mnemonic": "СЕть, натянутая на шест", "lookalikes": ["さ", "か"]},
    {"char": "そ", "romaji": "so",  "kind": "basic", "row": "sa", "mnemonic": "Зигзаг молнии — «СОрвалась с неба»", "lookalikes": ["え", "ろ"]},
    # --- た行 ---
    {"char": "た", "romaji": "ta",  "kind": "basic", "row": "ta", "mnemonic": "Латинские «t» и «a» рядом — ТА!", "lookalikes": ["な", "に"]},
    {"char": "ち", "romaji": "chi", "kind": "basic", "row": "ta", "mnemonic": "Пятёрка наоборот — «ЧИсло 5»", "lookalikes": ["さ", "き", "ら"]},
    {"char": "つ", "romaji": "tsu", "kind": "basic", "row": "ta", "mnemonic": "Волна ЦУнами", "lookalikes": ["う", "し", "ら"]},
    {"char": "て", "romaji": "te",  "kind": "basic", "row": "ta", "mnemonic": "Изогнутая рука (te = рука)", "lookalikes": ["で", "そ"]},
    {"char": "と", "romaji": "to",  "kind": "basic", "row": "ta", "mnemonic": "Палец ноги с занозой (toe)", "lookalikes": ["し", "ど"]},
    # --- な行 ---
    {"char": "な", "romaji": "na",  "kind": "basic", "row": "na", "mnemonic": "Крест с НАвесом и петелькой", "lookalikes": ["た", "は"]},
    {"char": "に", "romaji": "ni",  "kind": "basic", "row": "na", "mnemonic": "НИша с двумя полками", "lookalikes": ["こ", "た"]},
    {"char": "ぬ", "romaji": "nu",  "kind": "basic", "row": "na", "mnemonic": "Лапша (НУдлы) на вилке с петлёй", "lookalikes": ["め", "ね", "あ"]},
    {"char": "ね", "romaji": "ne",  "kind": "basic", "row": "na", "mnemonic": "Кошка (НЭко) с хвостом-петлёй", "lookalikes": ["わ", "れ", "ぬ"]},
    {"char": "の", "romaji": "no",  "kind": "basic", "row": "na", "mnemonic": "Вихрь-завиток — «НОль с хвостом»", "lookalikes": ["め", "ぬ"]},
    # --- は行 ---
    {"char": "は", "romaji": "ha",  "kind": "basic", "row": "ha", "mnemonic": "Стена и буква «а» — ХАта", "lookalikes": ["ほ", "け", "ま"]},
    {"char": "ひ", "romaji": "hi",  "kind": "basic", "row": "ha", "mnemonic": "Улыбка — «ХИ-хи»", "lookalikes": ["び", "ぴ"]},
    {"char": "ふ", "romaji": "fu",  "kind": "basic", "row": "ha", "mnemonic": "Гора ФУдзи с облачками", "lookalikes": ["ぶ", "う"]},
    {"char": "へ", "romaji": "he",  "kind": "basic", "row": "ha", "mnemonic": "Холмик: поднялся и спустился — «ХЭй!»", "lookalikes": ["く", "べ"]},
    {"char": "ほ", "romaji": "ho",  "kind": "basic", "row": "ha", "mnemonic": "Как は, но с крышей — ХОзяин достроил", "lookalikes": ["は", "け", "ま"]},
    # --- ま行 ---
    {"char": "ま", "romaji": "ma",  "kind": "basic", "row": "ma", "mnemonic": "Клубок с хвостиком — МАма вяжет", "lookalikes": ["は", "ほ", "も"]},
    {"char": "み", "romaji": "mi",  "kind": "basic", "row": "ma", "mnemonic": "Число 21 с петлёй — «МИ»", "lookalikes": ["ふ", "ん"]},
    {"char": "む", "romaji": "mu",  "kind": "basic", "row": "ma", "mnemonic": "Корова с рогом и хвостом — «МУ-у!»", "lookalikes": ["す", "お"]},
    {"char": "め", "romaji": "me",  "kind": "basic", "row": "ma", "mnemonic": "Глаз (мэ = глаз): петля с пересечением", "lookalikes": ["ぬ", "の", "あ"]},
    {"char": "も", "romaji": "mo",  "kind": "basic", "row": "ma", "mnemonic": "Червяк на крючке — МОрмышка", "lookalikes": ["ま", "し"]},
    # --- や行 ---
    {"char": "や", "romaji": "ya",  "kind": "basic", "row": "ya", "mnemonic": "Рогатка с натянутой резинкой — «Я!»", "lookalikes": ["か", "ゆ"]},
    {"char": "ゆ", "romaji": "yu",  "kind": "basic", "row": "ya", "mnemonic": "ЮРкая рыбка с плавником", "lookalikes": ["や", "よ"]},
    {"char": "よ", "romaji": "yo",  "kind": "basic", "row": "ya", "mnemonic": "ЙО-йо, повисшее на пальце", "lookalikes": ["ま", "ゆ"]},
    # --- ら行 ---
    {"char": "ら", "romaji": "ra",  "kind": "basic", "row": "ra", "mnemonic": "КобРА подняла голову", "lookalikes": ["ち", "う", "ろ"]},
    {"char": "り", "romaji": "ri",  "kind": "basic", "row": "ra", "mnemonic": "Две травинки — РИс растёт", "lookalikes": ["い", "け"]},
    {"char": "る", "romaji": "ru",  "kind": "basic", "row": "ra", "mnemonic": "Дорога с петлёй на конце — маршРУт", "lookalikes": ["ろ", "そ"]},
    {"char": "れ", "romaji": "re",  "kind": "basic", "row": "ra", "mnemonic": "Человек делает РЕверанс, отставив ногу", "lookalikes": ["わ", "ね", "ぬ"]},
    {"char": "ろ", "romaji": "ro",  "kind": "basic", "row": "ra", "mnemonic": "Как る, но без петли — доРОга прямая", "lookalikes": ["る", "そ"]},
    # --- わ行 + ん ---
    {"char": "わ", "romaji": "wa",  "kind": "basic", "row": "wa", "mnemonic": "Как れ, но с круглым боком — ВАтрушка", "lookalikes": ["ね", "れ"]},
    {"char": "を", "romaji": "wo",  "kind": "basic", "row": "wa", "mnemonic": "Человек замахнулся копьём — «ВО!»", "lookalikes": ["お", "と"]},
    {"char": "ん", "romaji": "n",   "kind": "basic", "row": "wa", "mnemonic": "Английская «n» курсивом — росчерк", "lookalikes": ["え", "そ"]},
    # --- дакутэн: が行 ---
